...
function runBaseTests() {
  px_vis_radar_1 = document.getElementById('px_vis_radar_1');

  suite('Base Automation Tests for px-vis-radar', function() {

    test('Polymer exists', function() {
      assert.isTrue(Polymer !== null);
    });
    test('px-vis-radar fixture is created', function() {
      assert.isTrue(document.getElementById('px_vis_radar_1') !== null);
    });
